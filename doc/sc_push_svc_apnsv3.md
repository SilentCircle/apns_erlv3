...
<pre><code>
nf_prop() = {alert, binary() | <a href="#type-alert_proplist">alert_proplist()</a>} | {badge, integer()} | {sound, binary()} | {'content-available', 0 | 1} | {category, binary()} | {extra, <a href="/home/efine/work/sc/open_source/scpf/apns_erlv3/_build/default/lib/apns_erl_util/doc/apns_json.md#type-json_term">apns_json:json_term()</a>}
</code></pre>
